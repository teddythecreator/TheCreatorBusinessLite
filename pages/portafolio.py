...
def page_portafolio():
    """
    Página de Portafolio: muestra ejemplos de proyectos en Alicante, Murcia y Valencia.
    """
    st.title("Portafolio Destacado 🖼️")
    st.write("Ejemplos de proyectos recientes en Alicante, Murcia y Valencia:")
    st.markdown("---")
